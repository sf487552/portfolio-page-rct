        ...
        <div className="projects">
            ...
            <div id="p2" className="wrapper">
                ...
                <div id="two">
                    ...
                    <p>This project showcases my skills using MongoDB with a Mongoose Schema and Express Routes. The site has been deployed using Heroku and MongoDB Atlas.</p>
                </div>
            </div>
            ...
            <div id="p4" className="wrapper">
                ...
                <div id="two">
                    ...
                    <p>This project was made using Third Party APIs along with HTML, CSS, and Javascript while using localStorage to store persistant data.</p>
                </div>
            </div>
